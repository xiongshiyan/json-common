package cn.zytx.common.json.jackson;

import cn.zytx.common.json.JsonObject;
import cn.zytx.common.json.JsonObjectBean;
import cn.zytx.common.json.jackjson.JSONObject;
...
public class JSONObjectTest {
    ...
    public void testFromMap() throws Exception {
        Map<String , Object> xx = new HashMap<>(2);
        xx.put("str","xxxx");
        xx.put("num",12);
        JsonObject jsonObject = this.jsonObject.fromMap(xx);
        System.out.println(jsonObject.toString());
    }
}